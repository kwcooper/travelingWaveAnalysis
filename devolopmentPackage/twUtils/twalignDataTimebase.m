function twalignDataTimebase(ratName,prefixes,ephysFolder,bonsaiTime,ref,filetype)
...
for iP = 1:length(prefixes)
  ...
  if exist([basePath filesep 'alignedEphysData.m'],'file')
  ...
  % SJV 170706 added option to read in open ephys for ECube. changed input parameters to alignVideo2LFP
