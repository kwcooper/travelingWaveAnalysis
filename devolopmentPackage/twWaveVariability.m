...
std_velocity = [0.5, 0.2278];  % standard deviation of velocity
figure
hold on
bar(1:2,mean_velocity)
errorbar(1:2,mean_velocity,std_velocity,'.')
...
% load roblePeakDist.mat % hh
% load robleTroughDist.mat % h
% 
% figure; plot(hh(2).XData, hh(2).YData, 'b');
% hold on; plot(h(2).XData, h(2).YData, 'r');
% title('Slopes: Peaks vs Troughs');
% xlabel('Slope'); ylabel('Number of Cycles'); 
